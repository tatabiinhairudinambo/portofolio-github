...
@section('title', 'Proyek - Portfolio Web Developer')

@section('content')
<!-- Bagian Hero -->
<section class="hero-section position-relative" style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('{{ asset('anime.png') }}') center/cover no-repeat; color: white; min-height: 60vh; display: flex; align-items: center;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card border-0 shadow-sm card-hover h-100">
                    <div class="position-relative overflow-hidden">
                        <img src="https://via.placeholder.com/400x250/{{ $index % 2 == 0 ? '667eea' : '764ba2' }}/ffffff?text={{ urlencode($project['title']) }}" 
                        ...
                        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center opacity-0 hover-overlay" 
                            ...
                            <div class="text-center">
                                <a href="{{ $project['demo'] }}" class="btn btn-light btn-sm me-2" target="_blank">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex gap-2 mt-auto">
                            <a href="{{ $project['demo'] }}" class="btn btn-primary-custom btn-sm flex-fill" target="_blank">
                                <i class="fas fa-eye me-1"></i>Live Demo
                            </a>
                            <a href="{{ $project['github'] }}" class="btn btn-outline-primary btn-sm flex-fill" target="_blank">
