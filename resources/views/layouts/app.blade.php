        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('projects') ? 'active' : '' }}" href="{{ route('projects') }}">Proyek</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('skills') ? 'active' : '' }}" href="{{ route('skills') }}">Keahlian</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-md-center">
                    ...
                    <p class="mt-2 mb-0">&copy; {{ date('Y') }} tatabiin hairudin ambo.</p>
                </div>
            </div>
        </div>
    </footer>
