<?php $__env->startSection('title', 'Beranda - Portfolio Web Developer'); ?>
        ...
        <div class="row justify-content-center text-center">
            <div class="col-12">
                ...
                <div class="profile-image-container mb-4">
                    <img src="<?php echo e(asset('beranda.jpg')); ?>" 
    ...
    @keyframes rgb {
        ...
        100% { background-position: 400% 50%; }
                    ...
                    <div class="d-flex justify-content-center gap-3 mt-4">
                        <a href="<?php echo e(route('projects')); ?>" class="btn btn-primary-custom btn-lg">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <a href="<?php echo e(route('about')); ?>" class="btn btn-primary-custom">
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow-lg card-hover position-relative overflow-hidden" style="background: rgba(255,255,255,0.95); backdrop-filter: blur(10px);">
                    <div class="position-relative video-preview-container">
                        ...
                        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center opacity-0 video-overlay" 
                            ...
                            <div class="text-center">
                                ...
                                <a href="<?php echo e(route('projects')); ?>" class="btn btn-outline-light btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('projects')); ?>" class="btn btn-outline-primary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\RND1\belajar pemula\portfolio-website\resources\views/portfolio/index.blade.php ENDPATH**/ ?>