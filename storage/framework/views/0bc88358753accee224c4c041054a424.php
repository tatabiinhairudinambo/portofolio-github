                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h3 class="mb-0 fw-bold">
                            <?php if($category == 'Backend'): ?>
                                <i class="fas fa-server me-2"></i>
                            <?php elseif($category == 'Frontend'): ?>
                    ...
                    <div class="card-body p-4">
                        <div class="row g-4">
                            <?php $__currentLoopData = $skillList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill => $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6">
                                <div class="skill-item">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h6 class="fw-bold mb-0"><?php echo e($skill); ?></h6>
                                        <span class="badge bg-primary"><?php echo e($level); ?>%</span>
                                    </div>
                                    <div class="skill-bar bg-light">
                                        <div class="skill-progress" data-width="<?php echo e($level); ?>%" style="width: 0%;"></div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\RND1\belajar pemula\portfolio-website\resources\views/portfolio/skills.blade.php ENDPATH**/ ?>